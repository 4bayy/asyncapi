    ...
    <div ref={dropdownRef} className={twMerge(`relative inline-block ${className}`)}>
      ...
      {isOpen && (
        <div
          ...
          className='absolute left-0 z-10 mt-1 max-h-72 min-w-full overflow-y-auto rounded-md border border-gray-300 bg-white py-1 shadow-lg dark:border-gray-700 dark:bg-dark-card md:min-w-64'
        >
          {options.map((option) => {
